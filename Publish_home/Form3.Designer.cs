...
namespace Publish_home
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGridView1.Size = new System.Drawing.Size(589, 454);
            ...
            "Сказка о нефти",
            "Система перевозки нефти",
            "Как добыть газ и не взлететь на воздух",
            "Все о добыче газа",
            "Зачем нужна нефть",
            "Как делать на газе по 30000 в день",
            "Химическое производство нефти и газа"});
            this.comboBox1.Location = new System.Drawing.Point(8, 303);
            ...
            this.label5.Text = "Удалить произведение";
            // 
            // button2
            // 
